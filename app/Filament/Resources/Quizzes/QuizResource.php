...
class QuizResource extends Resource
{
    ...
    {
        return [
            \App\Filament\Resources\Quizzes\RelationManagers\AttemptsRelationManager::class,
        ];
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'questions' => \App\Filament\Resources\Quizzes\Pages\ManageQuizQuestions::route('/{record}/questions'),
        ];
    }
}
